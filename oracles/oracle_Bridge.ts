import { type NonEmptyArray, type Oracle, StateManager, mode, parseEther } from '..'
...
const state = new StateManager<{ pools: LiquidityPool; burnRate: number }>({
	pools: {},
	burnRate: 0.5
})
const methods = {
...
const methodDescriptions = {
	addLiquidity: {
		...
		openStarLiquidity: '0x' as `0x${string}`,
		tokenLiquidity: '0x' as `0x${string}`
	}
}
...
const oracle: Oracle<typeof state.value, string, typeof methods> = {
	startupState,
	reputationChange,
	state,
	methods,
