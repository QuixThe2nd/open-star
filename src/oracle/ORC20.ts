...
export class ORC20Oracle<OracleName extends string, OracleState extends ORC20State, OracleMethods extends Record<string, (arg: any) => MethodReturn>> extends OpenStar<OracleName, OracleState, OracleMethods> {
